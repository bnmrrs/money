...
class Money
  ...
  class Currency
    ...
    TABLE = {
      ...
      :dop => { :priority => 9, :iso_code => "DRI", :name => "Diamond Resorts International Points",                            :symbol => "points",             :subunit => "point",       :subunit_to_unit => 1,  :symbol_first => false, :decimal_mark => ".", :thousands_separator => ","},
